                            ...
                            <div className={"flex-auto px-2"}>
                                <div className="max-w-3xl mx-auto">
                                    ...
                                    <AccordionItem title={"How fast will I receive my designs?"}>
                                        Updates will be provided within 1 to 3 business days, subject to the intricacy of the design.
                                        For instance, social media assets might be completed in 1 business day, whereas a comprehensive
                                        page design could require up to 3 days for the initial draft. Each design is uniquely crafted to your
                                        specifications, eschewing the use of pre-made templates.
                                    </AccordionItem>
                                    <AccordionItem title={"Can we have regular meetings?"}>
                                        No. They can take up a lot of time. All our interactions will be asynchronous via the
                                        Trello or Email to enhance workflow efficiency. However, should you require a more
                                        thorough explanation on any specific feature or feedback, feel free to create a detailed
                                        Loom video to delve into the particulars.
                                    </AccordionItem>
                                    <AccordionItem title={"How long does it take to complete a project?"}>
                                        It is really depends on the project&apos;s scope and complexity. Our <b>ESTIMATION </b>
                                        is about 1-3 months to finish small - medium project. Again, it&apos;s just an estimation. Not a fixed timeframe.
                                    </AccordionItem>
                                    ...
                                    <AccordionItem title={"Why not hire a freelancer, or a full-time designer?"}>
                                        ...
                                        <br />
                                        <br />
                                        Orenji Studio offers a streamlined alternative, bypassing the cumbersome hiring process.
                                        This approach saves you thousands of dollars monthly and enables immediate commencement of
